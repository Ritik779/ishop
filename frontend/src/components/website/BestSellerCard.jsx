...
const BestSellerCard = ({ name, orignal_price, _id, discount_price, main_image }) => {
    const [isHovered, setIsHovered] = useState(false);
    return (
        <Link href={`/product_listing/${_id}`}>
            <div
            ...
            >
                ...
                <div className="relative w-full h-40 flex items-center justify-center">
                    <img
                        ...
                        alt={name}
                        className={`w-full h-[170px] rounded-lg transition-all duration-300 ${isHovered ? "opacity-20" : "opacity-100"
                            }`}
                    />
                ...
                <div className="text-center mt-8">
                    ...
                    <div className="text-red-500 text-lg font-bold">
                        ₹{discount_price} <span className="text-gray-400 line-through text-sm">₹{orignal_price}</span>
                    </div>
                </div>
            </div>
        </Link>
